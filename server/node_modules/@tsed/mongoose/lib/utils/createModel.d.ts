 ...
 */
export declare function createModel<T>(target: any, schema: mongoose.Schema, name?: string, collection?: string, skipInit?: boolean, connection?: Connection): mongoose.Model<mongoose.Document, {}>;
